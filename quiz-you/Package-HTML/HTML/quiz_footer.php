    ...
    <div id="copyrights">
        ...
        <div class="container clearfix">
            ...
            <div class="col_half col_last tright">
                ...
                <i class="icon-envelope2"></i> info@quiz-you.com <span class="middot">&middot;</span> <i
                        class="icon-headphones"></i> +65-9006-5328 <span class="middot">&middot;</span> <i
                        class="icon-skype2"></i> QuizYouOnSkype
            </div>
