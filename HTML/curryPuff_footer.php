        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="newsletter">
                    <h4>Newsletter</h4>
                    <p>Keep up on our always evolving products and offers. Enter your e-mail and subscribe to our
                        newsletter.</p>
                    ...
                    <form id="newsletterForm" action="curryPuff_index.php" method="POST">
                ...
                <div class="col-md-4">
                    <nav id="sub-menu">
                        <ul>
                            ...
                            <li><a href="curryPuff_about.php">About</a></li>
...
<script src="vendor/brian.js"></script>
